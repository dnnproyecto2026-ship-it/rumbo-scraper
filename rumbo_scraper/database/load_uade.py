"""Validate and load the UADE dataset into Supabase."""
...
DEFAULT_INPUT = Path("data/uade_completo.json")
CORE_SECTIONS = (
...
def apply_dataset(dataset: dict[str, Any], client: Any | None = None) -> dict[str, int]:
    ...
    # UADE does not state which campus teaches each programme, and
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cargar el dataset de UADE")
