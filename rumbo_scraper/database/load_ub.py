"""Validate and load the Universidad de Belgrano dataset into Supabase."""
...
DEFAULT_INPUT = Path("data/ub_completo.json")
CORE_SECTIONS = (
...
def apply_dataset(dataset: dict[str, Any], client: Any | None = None) -> dict[str, int]:
    ...
    # Belgrano does not state which campus teaches each programme, and
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cargar el dataset de Belgrano")
