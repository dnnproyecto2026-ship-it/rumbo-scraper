"""Validate and load the UAI dataset into Supabase."""
...
DEFAULT_INPUT = Path("data/uai_completo.json")
CORE_SECTIONS = (
    "universidades", "sedes", "facultades", "carreras", "ofertas", "posgrados",
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cargar el dataset de la UAI")
