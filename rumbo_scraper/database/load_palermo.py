"""Validate and load the Palermo dataset into Supabase."""
...
DEFAULT_INPUT = Path("data/palermo_completo.json")
CORE_SECTIONS = (
    "universidades", "facultades", "carreras", "ofertas", "posgrados", "materias",
)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cargar el dataset de Palermo")
