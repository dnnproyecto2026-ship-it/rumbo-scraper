"""Validate and load the Universidad Austral dataset into Supabase."""
...
DEFAULT_INPUT = Path("data/austral_completo.json")
CORE_SECTIONS = (
...
def apply_dataset(dataset: dict[str, Any], client: Any | None = None) -> dict[str, int]:
    ...
    # Austral publishes the campus of each offer, so they can be linked.
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Cargar el dataset de Austral")
